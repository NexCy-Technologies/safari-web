    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-black text-white overflow-x-hidden font-sans">
        ...
        <div className="max-w-[90rem] mx-auto px-3 sm:px-4 md:px-6 lg:px-10 xl:px-12 2xl:px-16 py-2 sm:py-3 flex justify-between items-center">
          ...
          >
            <div className="relative w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-11 lg:h-11">
              <Image
                src="/logo.png"
                alt="Udawalawe Safari by Nuwan - Professional Wildlife Guide Logo"
                fill
            ...
            <div className="text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-[1.65rem] 2xl:text-[1.8rem] tracking-wide text-green-100 hover:text-green-300 transition-all duration-300 transform hover:scale-105 font-bold font-serif">
              Udawalawe Safari
            </div>
          </div>
          ...
          {heroImages.map((src, index) => (
            ...
            >
              <Image
                ...
                alt={`Udawalawe Safari Wildlife Adventure - Elephants and jeep safari in natural habitat ${index + 1}`}
                fill
      ...
      >
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-green-100 mb-4 font-bold font-serif">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6">
            {[
              ...
              >
                ...
                />
                <h3 className="font-semibold text-emerald-200 text-sm sm:text-base lg:text-lg mb-1">{item.title}</h3>
            ...
            {packages.map((pkg, i) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-emerald-200 font-bold mb-3 sm:mb-4 md:mb-4 group-hover:text-emerald-100 transition-colors duration-300 font-serif">
                    {pkg.title}
                  </h3>
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-emerald-200 mb-3 sm:mb-4 md:mb-6 font-bold font-serif">
                    {pkg.title}
                  </h3>
        ...
        <footer className="relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-16 sm:py-20 md:py-24">
            <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                  <div className="relative w-8 h-8 sm:w-10 sm:h-10">
                    <Image
                      src="/favicon.ico"
                      alt="Udawalawe Safari by Nuwan - Professional Wildlife Guide Favicon"
                      width={40}
                      height={40}
                  ...
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-200 font-serif">
                    Udawalawe Safari
                  </h2>
                </div>
              ...
              {/* Quick Links */}
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-green-200 font-serif flex items-center gap-1 sm:gap-2">
